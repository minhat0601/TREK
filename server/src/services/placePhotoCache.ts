...
// Overridable for tests (mirrors the Tripp_DB_FILE seam) so the suite never touches
// the real uploads tree.
const GOOGLE_PHOTO_DIR = process.env.Tripp_PLACE_PHOTO_DIR || path.join(__dirname, '../../uploads/photos/google');

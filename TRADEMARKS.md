...
This is the Tripp project's policy for the use of our trademarks. While Tripp is
...
be full participants in the Tripp project.

## Our trademarks

This policy covers the name "Tripp" as well as any associated logos, trade dress,
...
say you are distributing Tripp when you're distributing a modified version of it,
...
your website in a way that suggests that your website is an official Tripp
website or that we endorse your website. But, if true, you can say you like
Tripp, that you participate in the Tripp community, that you are providing an
unmodified version of Tripp, or that you wrote a guide describing how to use
Tripp.
...
When you redistribute an unmodified copy of Tripp, you are not changing the
...
you are redistributing an official Tripp distribution that has not been changed
in any way.

## Distribution of executable code that you have compiled, or modified code

You may use the word mark "Tripp", but not any Tripp logos, to truthfully
describe the origin of the software that you are providing, that is, that the
code you are distributing is a modification of Tripp. You may say, for example,
that "this software is derived from the source code for Tripp."
...
executable) on the condition that any executable is built from an official Tripp
...
The following clarifications apply specifically to common ways Tripp is
redistributed:

* **Self-hosted instances of unmodified Tripp.** You may refer to your instance
  as "a Tripp instance" or "running Tripp." You may not name the service itself
  in a way that suggests it is the official Tripp ("Tripp Cloud," "Tripp
  Official," etc.).
* **Mobile wrappers (WebView shells, Capacitor apps, native apps) pointing at
  Tripp.** You may describe your app as "a mobile client for Tripp" or "for use
  with Tripp." You may not publish it on app stores under the name "Tripp" or a
  confusingly similar name, and you may not use the Tripp logo as the app icon
  unless your wrapper distributes only an unmodified, official Tripp instance
  and you have obtained permission.
* **Forks of the Tripp source code.** Forks that diverge from upstream must use
  a different name. You may state that your fork is "based on Tripp" or "a fork
  of Tripp," but the project name itself must be your own.

## Statements about your software's relation to Tripp

You may use the word mark, but not Tripp logos, to truthfully describe the
relationship between your software and ours. The word mark "Tripp" should be
used after a verb or preposition that describes the relationship between your
software and ours. So you may say, for example, "Bob's app for Tripp" but may
not say "Bob's Tripp app." Some other examples that may work for you are:

* [Your software] uses Tripp
* [Your software] is powered by Tripp
* [Your software] runs on Tripp
* [Your software] for use with Tripp
* [Your software] for Tripp
...
is not covered, please open an issue on the Tripp GitHub repository or contact

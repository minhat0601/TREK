...
const texts: Record<string, DemoTexts> = {
  de: {
    ...
    titleAfter: '',
    title: 'Willkommen zur Tripp Demo',
  ...
  en: {
    ...
    titleAfter: '',
    title: 'Welcome to the Tripp Demo',
  ...
  es: {
    ...
    titleAfter: '',
    title: 'Bienvenido a la demo de Tripp',
  ...
  ar: {
    ...
    titleAfter: '',
    title: 'مرحبًا بك في النسخة التجريبية من Tripp',
  ...
  id: {
    ...
    titleAfter: '',
    title: 'Selamat datang di Demo Tripp',
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 14 }}>
          ...
          <h2 style={{ margin: 0, fontSize: 17, fontWeight: 700, color: '#111827', display: 'flex', alignItems: 'center', gap: 5 }}>
            {t.titleBefore}<img src="/text-dark.svg" alt="Tripp" style={{ height: 18 }} />{t.titleAfter}
          </h2>
        </div>

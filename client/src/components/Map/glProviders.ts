...
// A few Tripp UI language codes differ from what the GL basemap expects for its labels.
const BASEMAP_LANG_OVERRIDES: Record<string, string> = {
  br: 'pt',          // Tripp 'br' = Brazilian Portuguese
  gr: 'el',          // Tripp 'gr' = Greek
  zh: 'zh-Hans',
  zhTw: 'zh-Hant',
  'zh-TW': 'zh-Hant',
}
...
/**
 * Maps a Tripp UI language code to the label language the GL basemap expects. Used to pin

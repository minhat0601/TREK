...
const vacay: TranslationStrings = {
  ...
  'vacay.sharingHint': 'Μοιραστείτε το πλάνο διακοπών σας με άλλους χρήστες Tripp',
  'vacay.owner': 'Κάτοχος',
  'vacay.shareEmailPlaceholder': 'Email χρήστη Tripp',
  ...
  'vacay.inviteHint': 'Προσκαλέστε έναν άλλο χρήστη Tripp για να μοιραστείτε ένα κοινό ημερολόγιο διακοπών.',

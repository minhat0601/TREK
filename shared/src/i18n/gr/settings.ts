...
const settings: TranslationStrings = {
  ...
  'settings.about.supporters.title': 'Συνταξιδιώτες για το Tripp',
  'settings.about.supporters.subtitle':
    'Καθώς εσείς σχεδιάζετε την επόμενή σας διαδρομή, αυτοί οι άνθρωποι βοηθούν να σχεδιαστεί το μέλλον του Tripp. Η μηνιαία τους συνεισφορά πηγαίνει απευθείας στην ανάπτυξη και σε πραγματικές ώρες εργασίας — ώστε το Tripp να παραμένει Open Source.',
  ...
  'settings.about.description':
    'Το Tripp είναι ένας self-hosted ταξιδιωτικός σχεδιαστής που σας βοηθά να οργανώσετε τα ταξίδια σας από την πρώτη ιδέα μέχρι την τελευταία ανάμνηση. Σχεδιασμός ημερών, προϋπολογισμός, λίστες πακεταρίσματος, φωτογραφίες και πολλά άλλα — όλα σε ένα μέρος, στον δικό σας server.',
  ...
  'settings.airtrail.writeBackHint':
    'Απενεργοποιημένο από προεπιλογή: το AirTrail είναι η πηγή αλήθειας και το Tripp μόνο διαβάζει από αυτό. Ενεργοποιήστε το για να στέλνετε πίσω στο AirTrail τις αλλαγές που κάνετε στο Tripp.',

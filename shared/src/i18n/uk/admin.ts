...
const admin: TranslationStrings = {
  ...
  'admin.addons.subtitle': 'Увімкніть або вимкніть функції, щоб налаштувати Tripp під себе.',
  ...
  'admin.weather.description':
    'Tripp використовує Open-Meteo як джерело даних про погоду. Open-Meteo — безкоштовний сервіс з відкритим кодом, API-ключ не потрібен.',
  ...
  'admin.github.support': 'Допомагає продовжувати розробку Tripp',
  'admin.github.error': 'Не вдалося завантажити релізи',
  'admin.github.by': 'від',
  'admin.update.available': 'Доступне оновлення',
  'admin.update.text': 'Доступна версія Tripp {version}. У вас встановлено {current}.',
  ...
  'admin.update.confirmText': 'Tripp буде оновлено з {current} до {version}. Сервер перезапуститься автоматично.',
  ...
  'admin.update.dockerText':
    'Ваш екземпляр Tripp працює в Docker. Для оновлення до {version} виконайте ці команди на сервері:',
  'admin.update.nonDockerText':
    'Цей екземпляр Tripp не працює в Docker. Щоб оновити до {version}, повторно запустіть метод встановлення або оновлення, який ви використовували, — наприклад, у Proxmox Community Scripts запустіть оновлення з консолі LXC:',

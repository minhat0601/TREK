...
const uk: NotificationLocale = {
  email: {
    footer: 'Ви отримали це, оскільки увімкнули сповіщення в Tripp.',
    manage: 'Керувати налаштуваннями у Налаштуваннях',
    madeWith: 'Made with',
    openTrek: 'Відкрити Tripp',
  },
  events: {
    trip_invite: (p) => ({
    ...
    vacay_invite: (p) => ({
      ...
      body: `${p.actor} запрошує вас об'єднати плани відпустки. Відкрийте Tripp, щоб прийняти або відхилити.`,
    }),
    photos_shared: (p) => ({
    ...
    version_available: (p) => ({
      title: 'Доступна нова версія Tripp',
      body: `Tripp ${p.version} тепер доступний. Перейдіть до панелі адміністратора для оновлення.`,
    }),
  ...
  passwordReset: {
    ...
    greeting: 'Привіт',
    body: 'Ми отримали запит на скидання пароля вашого облікового запису Tripp. Натисніть кнопку нижче, щоб встановити новий пароль.',

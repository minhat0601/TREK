...
const system_notice: TranslationStrings = {
  'system_notice.welcome_v1.title': 'Ласкаво просимо в Tripp',
  ...
  'system_notice.welcome_v1.hero_alt': 'Живописне місце призначення з інтерфейсом Tripp',
  ...
  'system_notice.thank_you_support.title': 'Дякую, що користуєтесь Tripp',
  'system_notice.thank_you_support.body':
    'Невелика подяка за те, що встановили Tripp — для мене це справді багато значить.\n\nЯ розробник-одинак і створюю Tripp у вільний час. Усе почалося як маленький інструмент для моїх власних поїздок, і відтоді я щиро вражений підтримкою та інтересом спільноти. Tripp зроблено з великою любов’ю з мого боку — але також завдяки багатьом чудовим зовнішнім контриб’юторам, які допомогли його сформувати.\n\n**Tripp має відкритий код і повністю безкоштовний — і таким залишиться назавжди. Жодних платних тарифів, жодних підписок, жодних підводних каменів. Обіцяю.**\n\nЯкщо Tripp корисний для вас і ви хочете підтримати його розробку, невелика кава справді допомагає мені продовжувати — жодного тиску, але кожна чашка підтримує ці пізні ночі.\n\nДякую, що ви тут.\n\n— Maurice',

...
const vacay: TranslationStrings = {
  ...
  'vacay.sharingHint': 'Поділіться планом відпустки з іншими користувачами Tripp',
  'vacay.owner': 'Власник',
  'vacay.shareEmailPlaceholder': 'Ел. пошта користувача Tripp',
  ...
  'vacay.inviteHint': 'Запросіть іншого користувача Tripp для спільного календаря відпусток.',

...
const admin: TranslationStrings = {
  ...
  'admin.addons.subtitle': 'Tripp deneyiminizi özelleştirmek için özellikleri etkinleştirin veya devre dışı bırakın.',
  ...
  'admin.weather.description':
    "Tripp, hava durumu veri kaynağı olarak Open-Meteo'yu kullanıyor. Open-Meteo ücretsiz, açık kaynaklı bir hava durumu hizmetidir; API anahtarı gerekmez.",
  ...
  'admin.github.by': 'ile',
  'admin.github.support': "Tripp'i geliştirmeye devam etmeme yardımcı oluyor",
  'admin.update.available': 'Güncelleme mevcut',
  'admin.update.text': 'Tripp {versiyon} mevcut. {current} çalıştırıyorsunuz.',
  ...
  'admin.update.confirmText':
    'Tripp, {current} sürümünden {version} sürümüne güncellenecek. Sunucu daha sonra otomatik olarak yeniden başlatılacaktır.',
  ...
  'admin.update.dockerText':
    "Tripp örneğiniz Docker'da çalışır. {version} sürümüne güncellemek için sunucunuzda aşağıdaki komutları çalıştırın:",
  'admin.update.nonDockerText':
    'Bu Tripp örneği Docker üzerinde çalışmıyor. {version} sürümüne güncellemek için kullandığınız kurulum veya güncelleme yöntemini yeniden çalıştırın — örneğin Proxmox Community Scripts kullanıyorsanız güncellemeyi LXC konsolundan çalıştırın:',

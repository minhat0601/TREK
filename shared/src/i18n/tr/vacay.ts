...
const vacay: TranslationStrings = {
  ...
  'vacay.sharingHint': 'Tatil planınızı diğer Tripp kullanıcılarıyla paylaşın',
  'vacay.owner': 'Mal sahibi',
  'vacay.shareEmailPlaceholder': 'Tripp kullanıcısının e-postası',
  ...
  'vacay.inviteHint': 'Başka bir Tripp kullanıcısını birleşik bir tatil takvimini paylaşmaya davet edin.',

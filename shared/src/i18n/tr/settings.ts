...
const settings: TranslationStrings = {
  ...
  'settings.about.supporters.title': 'Tripp için seyahat Arkadaşları',
  'settings.about.supporters.subtitle':
    "While you're planning your next route, these folks are helping plan Tripp's future. Their monthly contribution goes straight into development and real hours spent — so Tripp stays Open Source.",
  ...
  'settings.about.description':
    'Tripp, seyahatlerinizi ilk fikirden son anıya kadar organize etmenize yardımcı olan, kendi kendine barındırılan bir seyahat planlayıcıdır. Gün planlaması, bütçe, paketleme listeleri, fotoğraflar ve çok daha fazlası; hepsi tek bir yerde, kendi sunucunuzda.',
  ...
  'settings.airtrail.writeBackHint':
    'Varsayılan olarak kapalı: AirTrail asıl kaynaktır ve Tripp yalnızca okur. Tripp’te yapılan değişiklikleri AirTrail’e geri göndermek için açın.',

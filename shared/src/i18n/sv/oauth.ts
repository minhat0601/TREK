...
const oauth: TranslationStrings = {
  ...
  'oauth.authorize.loginDescription': '{client} vill ha åtkomst till ditt Tripp konto. Logga in först.',
  'oauth.authorize.loginButton': 'Logga in på Tripp',
  'oauth.authorize.requestLabel': 'Begäran om behörighet',
  'oauth.authorize.requestDescription': 'Den här applikationen begär åtkomst till ditt Tripp konto.',

...
const admin: TranslationStrings = {
  ...
  'admin.addons.subtitle': 'Aktivera eller inaktivera funktioner för att anpassa din Tripp-upplevelse.',
  ...
  'admin.weather.description':
    'Tripp använder Open-Meteo som källa för väderdata. Open-Meteo är en kostnadsfri vädertjänst med öppen källkod – ingen API-nyckel krävs.',
  ...
  'admin.github.by': 'av',
  'admin.github.support': 'Hjälper mig att fortsätta bygga Tripp',
  'admin.update.available': 'Uppdatering tillgänglig',
  'admin.update.text': 'Tripp {version} finns tillgängligt. Du kör {current}.',
  ...
  'admin.update.confirmText':
    'Tripp kommer att uppdateras från {current} till {version}. Servern startas om automatiskt därefter.',
  ...
  'admin.update.dockerText':
    'Din Tripp-instans körs i Docker. För att uppdatera till {version} kör du följande kommandon på din server:',
  'admin.update.nonDockerText':
    'Denna Tripp-instans körs inte i Docker. För att uppdatera till {version}, kör installations- eller uppdateringsmetod du använde på nytt — till exempel, i Proxmox Community Scripts kör du uppdateringen från LXC-konsolen:',

...
const vacay: TranslationStrings = {
  ...
  'vacay.sharingHint': "Partagez votre plan de vacances avec d'autres utilisateurs Tripp",
  'vacay.owner': 'Propriétaire',
  'vacay.shareEmailPlaceholder': "E-mail de l'utilisateur Tripp",
  ...
  'vacay.inviteHint': 'Invitez un autre utilisateur Tripp à partager un calendrier de vacances combiné.',

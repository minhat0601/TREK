...
const admin: TranslationStrings = {
  ...
  'admin.addons.subtitle': 'Activez ou désactivez des fonctionnalités pour personnaliser votre expérience Tripp.',
  ...
  'admin.weather.description':
    'Tripp utilise Open-Meteo comme source de données météo. Open-Meteo est un service météo gratuit et open source — aucune clé API requise.',
  ...
  'admin.github.support': 'Aidez à poursuivre le développement de Tripp',
  'admin.github.error': 'Impossible de charger les versions',
  'admin.github.by': 'par',
  'admin.update.available': 'Mise à jour disponible',
  'admin.update.text': 'Tripp {version} est disponible. Vous utilisez {current}.',
  ...
  'admin.update.confirmText':
    'Tripp sera mis à jour de {current} vers {version}. Le serveur redémarrera automatiquement ensuite.',
  ...
  'admin.update.dockerText':
    'Votre instance Tripp fonctionne dans Docker. Pour mettre à jour vers {version}, exécutez les commandes suivantes sur votre serveur :',
  'admin.update.nonDockerText':
    "Cette instance Tripp ne fonctionne pas dans Docker. Pour mettre à jour vers {version}, relancez la méthode d'installation ou de mise à jour que vous avez utilisée — par exemple, sur Proxmox Community Scripts, lancez la mise à jour depuis la console LXC :",

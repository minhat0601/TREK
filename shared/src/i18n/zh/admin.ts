...
const admin: TranslationStrings = {
  ...
  'admin.addons.subtitle': '启用或禁用功能以自定义你的 Tripp 体验。',
  ...
  'admin.weather.description': 'Tripp 使用 Open-Meteo 作为天气数据源。Open-Meteo 是免费的开源天气服务——无需 API 密钥。',
  ...
  'admin.github.support': '帮助我继续开发 Tripp',
  'admin.github.error': '加载版本失败',
  'admin.github.by': '作者',
  'admin.update.available': '有可用更新',
  'admin.update.text': 'Tripp {version} 已发布。你当前使用的是 {current}。',
  'admin.update.button': '在 GitHub 查看',
  'admin.update.install': '安装更新',
  'admin.update.confirmTitle': '确定安装更新？',
  'admin.update.confirmText': 'Tripp 将从 {current} 更新到 {version}。服务器将自动重启。',
  ...
  'admin.update.dockerText': '你的 Tripp 实例运行在 Docker 中。要更新到 {version}，请在服务器上执行以下命令：',
  'admin.update.nonDockerText': '此 Tripp 实例未运行在 Docker 中。要更新到 {version}，请重新执行你当初使用的安装或更新方式——例如，在 Proxmox Community Scripts 上，从 LXC 控制台运行更新：',

...
const vacay: TranslationStrings = {
  ...
  'vacay.sharingHint': 'Condividi il tuo piano ferie con altri utenti Tripp',
  'vacay.owner': 'Proprietario',
  'vacay.shareEmailPlaceholder': "Email dell'utente Tripp",
  ...
  'vacay.inviteHint': 'Invita un altro utente Tripp a condividere un calendario ferie combinato.',

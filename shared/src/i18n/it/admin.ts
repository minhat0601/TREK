...
const admin: TranslationStrings = {
  ...
  'admin.addons.subtitle': 'Abilita o disabilita le funzionalità per personalizzare la tua esperienza Tripp.',
  ...
  'admin.weather.description':
    'Tripp utilizza Open-Meteo come fonte dei dati meteo. Open-Meteo è un servizio meteo gratuito e open-source — non è richiesta alcuna chiave API.',
  ...
  'admin.github.by': 'da',
  'admin.github.support': 'Mi aiuta a continuare a sviluppare Tripp',
  'admin.update.available': 'Aggiornamento disponibile',
  'admin.update.text': 'Tripp {version} è disponibile. Stai eseguendo {current}.',
  ...
  'admin.update.confirmText':
    'Tripp verrà aggiornato da {current} a {version}. Il server si riavvierà automaticamente in seguito.',
  ...
  'admin.update.dockerText':
    'La tua istanza Tripp è in esecuzione in Docker. Per aggiornare alla versione {version}, esegui i seguenti comandi sul tuo server:',
  'admin.update.nonDockerText':
    "Questa istanza Tripp non è in esecuzione in Docker. Per aggiornare alla versione {version}, riesegui il metodo di installazione o aggiornamento che hai usato — ad esempio, su Proxmox Community Scripts esegui l'aggiornamento dalla console LXC:",

...
const admin: TranslationStrings = {
  ...
  'admin.addons.subtitle': 'فعّل أو عطّل الميزات لتخصيص تجربة Tripp.',
  ...
  'admin.weather.description':
    'يستخدم Tripp خدمة Open-Meteo كمصدر لبيانات الطقس. وهي خدمة مجانية ومفتوحة المصدر ولا تتطلب مفتاح API.',
  ...
  'admin.github.support': 'يساعدني في تطوير Tripp',
  'admin.update.available': 'يتوفر تحديث',
  'admin.update.text': 'Tripp {version} متوفر. أنت تستخدم {current}.',
  'admin.update.button': 'عرض على GitHub',
  'admin.update.install': 'تثبيت التحديث',
  'admin.update.confirmTitle': 'تثبيت التحديث؟',
  'admin.update.confirmText': 'سيتم تحديث Tripp من {current} إلى {version}. سيُعاد تشغيل الخادم تلقائيًا بعد ذلك.',
  ...
  'admin.update.dockerText': 'يعمل Tripp الخاص بك في Docker. للتحديث إلى {version}، نفّذ الأوامر التالية على الخادم:',
  'admin.update.nonDockerText':
    'لا يعمل Tripp هذا في Docker. للتحديث إلى {version}، أعد تشغيل طريقة التثبيت أو التحديث التي استخدمتها — على سبيل المثال، في Proxmox Community Scripts نفّذ التحديث من وحدة تحكم LXC:',

...
const oauth: TranslationStrings = {
  ...
  'oauth.authorize.loginDescription': '{client} wants access to your Tripp account. Please sign in first.', // en-fallback
  'oauth.authorize.loginButton': 'Sign in to Tripp', // en-fallback
  'oauth.authorize.requestLabel': 'Authorization Request', // en-fallback
  'oauth.authorize.requestDescription': 'This application is requesting access to your Tripp account.', // en-fallback

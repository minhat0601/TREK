...
const settings: TranslationStrings = {
  ...
  'settings.about.supporters.title': 'Reisebegleitung für Tripp',
  'settings.about.supporters.subtitle':
    'Während du deine nächste Route planst, planen diese Leute mit, wie Tripp weitergeht. Ihr monatlicher Beitrag fließt direkt in Entwicklung und echten Zeitaufwand — damit Tripp Open Source bleibt.',
  ...
  'settings.about.description':
    'Tripp ist ein selbst gehosteter Reiseplaner, der dir hilft, deine Trips von der ersten Idee bis zur letzten Erinnerung zu organisieren. Tagesplanung, Budget, Packlisten, Fotos und vieles mehr — alles an einem Ort, auf deinem eigenen Server.',
  ...
  'settings.airtrail.writeBackHint':
    'Standardmäßig aus: AirTrail ist die maßgebliche Quelle und Tripp liest nur. Aktivieren, um in Tripp vorgenommene Änderungen zurück an AirTrail zu senden.',

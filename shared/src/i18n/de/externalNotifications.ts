...
const de: NotificationLocale = {
  email: {
    footer: 'Du erhältst diese E-Mail, weil du Benachrichtigungen in Tripp aktiviert hast.',
    manage: 'Einstellungen verwalten',
    madeWith: 'Made with',
    openTrek: 'Tripp öffnen',
  },
  events: {
    trip_invite: (p) => ({
    ...
    vacay_invite: (p) => ({
      ...
      body: `${p.actor} hat dich eingeladen, Urlaubspläne zu fusionieren. Öffne Tripp um anzunehmen oder abzulehnen.`,
    }),
    photos_shared: (p) => ({
    ...
    version_available: (p) => ({
      title: 'Neue Tripp-Version verfügbar',
      body: `Tripp ${p.version} ist jetzt verfügbar. Besuche das Admin-Panel zum Aktualisieren.`,
    }),
  ...
  passwordReset: {
    ...
    greeting: 'Hallo',
    body: 'Wir haben eine Anfrage erhalten, das Passwort für dein Tripp-Konto zurückzusetzen. Klicke auf den Button unten, um ein neues Passwort festzulegen.',

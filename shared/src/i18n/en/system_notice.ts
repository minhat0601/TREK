...
const system_notice: TranslationStrings = {
  ...
  'system_notice.welcome_v1.title': 'Welcome to Tripp',
  ...
  'system_notice.welcome_v1.hero_alt': 'A scenic travel destination with Tripp planning UI overlay',
  ...
  'system_notice.thank_you_support.title': 'Thank you for using Tripp',
  'system_notice.thank_you_support.body':
    "A quick thank-you for installing Tripp — it genuinely means a lot.\n\nI'm a solo developer and I build Tripp in my spare time. It started as a little tool just for my own trips, and I'm honestly blown away by the support and interest from the community since then. Tripp is made with a lot of heart on my side — but also thanks to the many amazing external contributors who've helped shape it.\n\n**Tripp is open source and completely free — and it will stay that way forever. No paid tiers, no subscriptions, no catch. I promise.**\n\nIf Tripp is useful to you and you'd like to support its development, a small coffee genuinely helps me keep building — no pressure at all, but every cup keeps the late nights going.\n\nThank you for being here.\n\n— Maurice",

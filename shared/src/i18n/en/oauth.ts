...
const oauth: TranslationStrings = {
  ...
  'oauth.authorize.loginDescription': '{client} wants access to your Tripp account. Please sign in first.',
  'oauth.authorize.loginButton': 'Sign in to Tripp',
  'oauth.authorize.requestLabel': 'Authorization Request',
  'oauth.authorize.requestDescription': 'This application is requesting access to your Tripp account.',

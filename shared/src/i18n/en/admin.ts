...
const admin: TranslationStrings = {
  ...
  'admin.addons.subtitle': 'Enable or disable features to customize your Tripp experience.',
  ...
  'admin.weather.description':
    'Tripp uses Open-Meteo as its weather data source. Open-Meteo is a free, open-source weather service — no API key required.',
  ...
  'admin.github.by': 'by',
  'admin.github.support': 'Helps me keep building Tripp',
  'admin.update.available': 'Update available',
  'admin.update.text': 'Tripp {version} is available. You are running {current}.',
  'admin.update.button': 'View on GitHub',
  'admin.update.install': 'Install Update',
  'admin.update.confirmTitle': 'Install Update?',
  'admin.update.confirmText':
    'Tripp will be updated from {current} to {version}. The server will restart automatically afterwards.',
  ...
  'admin.update.dockerText':
    'Your Tripp instance runs in Docker. To update to {version}, run the following commands on your server:',
  'admin.update.nonDockerText':
    'This Tripp instance is not running in Docker. To update to {version}, re-run the install or update method you used — for example, on Proxmox Community Scripts run the update from the LXC console:',

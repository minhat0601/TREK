...
const vacay: TranslationStrings = {
  ...
  'vacay.sharingHint': 'Compartilhe seu plano de férias com outros usuários do Tripp',
  'vacay.owner': 'Proprietário',
  'vacay.shareEmailPlaceholder': 'E-mail do usuário Tripp',
  ...
  'vacay.inviteHint': 'Convide outro usuário Tripp para compartilhar um calendário de férias combinado.',

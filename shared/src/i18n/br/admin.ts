...
const admin: TranslationStrings = {
  ...
  'admin.addons.subtitle': 'Ative ou desative recursos para personalizar sua experiência no Tripp.',
  ...
  'admin.weather.description':
    'O Tripp usa Open-Meteo como fonte de clima. Open-Meteo é um serviço gratuito e de código aberto — sem chave de API.',
  ...
  'admin.github.by': 'por',
  'admin.github.support': 'Ajuda a continuar desenvolvendo o Tripp',
  'admin.update.available': 'Atualização disponível',
  'admin.update.text': 'O Tripp {version} está disponível. Você está na {current}.',
  ...
  'admin.update.confirmText':
    'O Tripp será atualizado de {current} para {version}. O servidor reiniciará automaticamente em seguida.',
  ...
  'admin.update.dockerText': 'Sua instância Tripp roda no Docker. Para atualizar para {version}, execute no servidor:',
  'admin.update.nonDockerText':
    'Esta instância do Tripp não está rodando no Docker. Para atualizar para {version}, execute novamente o método de instalação ou atualização que você usou — por exemplo, no Proxmox Community Scripts, execute a atualização a partir do console do LXC:',

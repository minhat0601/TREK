...
const admin: TranslationStrings = {
  ...
  'admin.addons.subtitle': 'Включайте или отключайте функции для настройки Tripp под себя.',
  ...
  'admin.weather.description':
    'Tripp использует Open-Meteo как источник данных о погоде. Open-Meteo — бесплатный сервис с открытым кодом, API-ключ не требуется.',
  ...
  'admin.github.support': 'Помогает продолжать разработку Tripp',
  'admin.github.error': 'Не удалось загрузить релизы',
  'admin.github.by': 'от',
  'admin.update.available': 'Доступно обновление',
  'admin.update.text': 'Доступна версия Tripp {version}. У вас установлена {current}.',
  ...
  'admin.update.confirmText': 'Tripp будет обновлён с {current} до {version}. Сервер перезапустится автоматически.',
  ...
  'admin.update.dockerText':
    'Ваш экземпляр Tripp работает в Docker. Для обновления до {version} выполните следующие команды на сервере:',
  'admin.update.nonDockerText':
    'Этот экземпляр Tripp работает не в Docker. Чтобы обновиться до {version}, повторно запустите способ установки или обновления, который вы использовали, — например, в Proxmox Community Scripts выполните обновление из консоли LXC:',

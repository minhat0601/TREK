...
const vacay: TranslationStrings = {
  ...
  'vacay.sharingHint': 'Поделитесь планом отпуска с другими пользователями Tripp',
  'vacay.owner': 'Владелец',
  'vacay.shareEmailPlaceholder': 'Эл. почта пользователя Tripp',
  ...
  'vacay.inviteHint': 'Пригласите другого пользователя Tripp для совместного календаря отпусков.',

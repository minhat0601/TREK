...
const system_notice: TranslationStrings = {
  'system_notice.welcome_v1.title': 'Добро пожаловать в Tripp',
  ...
  'system_notice.welcome_v1.hero_alt': 'Живописное место назначения с интерфейсом Tripp',
  ...
  'system_notice.thank_you_support.title': 'Спасибо, что выбрали Tripp',
  'system_notice.thank_you_support.body':
    'Небольшое спасибо за то, что установили Tripp — для меня это правда очень много значит.\n\nЯ разработчик-одиночка и делаю Tripp в свободное время. Всё началось как маленький инструмент для моих собственных поездок, и я, честно говоря, поражён той поддержкой и интересом, которые проявило сообщество с тех пор. Tripp создаётся с большой любовью с моей стороны — но также благодаря множеству замечательных внешних участников, которые помогли его сформировать.\n\n**Tripp — это открытый исходный код и полностью бесплатно — и так будет всегда. Никаких платных тарифов, никаких подписок, никаких подвохов. Обещаю.**\n\nЕсли Tripp вам полезен и вы хотите поддержать его развитие, маленький кофе по-настоящему помогает мне продолжать — без всякого давления, но каждая чашка даёт силы для поздних ночей.\n\nСпасибо, что вы здесь.\n\n— Maurice',

...
const admin: TranslationStrings = {
  ...
  'admin.addons.subtitle': '기능을 활성화 또는 비활성화하여 Tripp 경험을 맞춤 설정하세요.',
  ...
  'admin.weather.description':
    'Tripp은 날씨 데이터 소스로 Open-Meteo를 사용합니다. Open-Meteo는 무료 오픈 소스 날씨 서비스로 API 키가 필요 없습니다.',
  ...
  'admin.github.by': '작성자',
  'admin.github.support': 'Tripp 개발 지속에 도움이 됩니다',
  'admin.update.available': '업데이트 사용 가능',
  'admin.update.text': 'Tripp {version}이(가) 사용 가능합니다. 현재 {current}을(를) 실행 중입니다.',
  'admin.update.button': 'GitHub에서 보기',
  'admin.update.install': '업데이트 설치',
  'admin.update.confirmTitle': '업데이트를 설치할까요?',
  'admin.update.confirmText': 'Tripp이 {current}에서 {version}으로 업데이트됩니다. 서버가 이후 자동으로 재시작됩니다.',
  ...
  'admin.update.dockerText':
    'Tripp 인스턴스가 Docker에서 실행 중입니다. {version}으로 업데이트하려면 서버에서 다음 명령을 실행하세요:',
  'admin.update.nonDockerText':
    '이 Tripp 인스턴스는 Docker에서 실행되고 있지 않습니다. {version}으로 업데이트하려면 사용했던 설치 또는 업데이트 방법을 다시 실행하세요 — 예를 들어 Proxmox Community Scripts에서는 LXC 콘솔에서 업데이트를 실행하세요:',

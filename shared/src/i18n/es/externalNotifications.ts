...
const es: NotificationLocale = {
  email: {
    footer: 'Recibiste esto porque tienes las notificaciones activadas en Tripp.',
    manage: 'Gestionar preferencias',
    madeWith: 'Made with',
    openTrek: 'Abrir Tripp',
  },
  events: {
    trip_invite: (p) => ({
    ...
    vacay_invite: (p) => ({
      ...
      body: `${p.actor} te invitó a fusionar planes de vacaciones. Abre Tripp para aceptar o rechazar.`,
    }),
    photos_shared: (p) => ({
    ...
    version_available: (p) => ({
      title: 'Nueva versión de Tripp disponible',
      body: `Tripp ${p.version} ya está disponible. Visita el panel de administración para actualizar.`,
    }),
  ...
  passwordReset: {
    ...
    greeting: 'Hola',
    body: 'Recibimos una solicitud para restablecer la contraseña de tu cuenta de Tripp. Haz clic en el botón de abajo para establecer una nueva contraseña.',

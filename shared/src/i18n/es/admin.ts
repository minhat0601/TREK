...
const admin: TranslationStrings = {
  ...
  'admin.addons.subtitle': 'Activa o desactiva funciones para personalizar tu experiencia en Tripp.',
  ...
  'admin.weather.description':
    'Tripp utiliza Open-Meteo como fuente de datos meteorológicos. Open-Meteo es un servicio meteorológico gratuito y de código abierto: no requiere clave API.',
  ...
  'admin.github.support': 'Ayuda a seguir desarrollando Tripp',
  'admin.github.error': 'No se pudieron cargar las versiones',
  'admin.github.by': 'por',
  'admin.update.available': 'Actualización disponible',
  'admin.update.text': 'Tripp {version} está disponible. Estás usando {current}.',
  ...
  'admin.update.confirmText':
    'Tripp se actualizará de {current} a {version}. Después, el servidor se reiniciará automáticamente.',
  ...
  'admin.update.dockerText':
    'Tu instancia de Tripp se ejecuta en Docker. Para actualizar a {version}, ejecuta los siguientes comandos en tu servidor:',
  'admin.update.nonDockerText':
    'Esta instancia de Tripp no se ejecuta en Docker. Para actualizar a {version}, vuelve a ejecutar el método de instalación o actualización que utilizaste; por ejemplo, en Proxmox Community Scripts ejecuta la actualización desde la consola LXC:',

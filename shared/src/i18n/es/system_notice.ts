...
const system_notice: TranslationStrings = {
  'system_notice.welcome_v1.title': 'Bienvenido a Tripp',
  ...
  'system_notice.welcome_v1.hero_alt': 'Destino de viaje pintoresco con la interfaz de Tripp',
  ...
  'system_notice.thank_you_support.title': 'Gracias por usar Tripp',
  'system_notice.thank_you_support.body':
    'Un pequeño agradecimiento por instalar Tripp — de verdad significa mucho para mí.\n\nSoy un desarrollador independiente y construyo Tripp en mi tiempo libre. Empezó como una pequeña herramienta solo para mis propios viajes, y sinceramente me deja sin palabras todo el apoyo y el interés de la comunidad desde entonces. Tripp está hecho con mucho cariño de mi parte — pero también gracias a los muchos colaboradores externos increíbles que han ayudado a darle forma.\n\n**Tripp es open source y completamente gratuito — y seguirá siéndolo para siempre. Sin planes de pago, sin suscripciones, sin trampa. Te lo prometo.**\n\nSi Tripp te resulta útil y quieres apoyar su desarrollo, un pequeño café me ayuda de verdad a seguir construyendo — sin ninguna presión, pero cada taza mantiene vivas las noches en vela.\n\nGracias por estar aquí.\n\n— Maurice',

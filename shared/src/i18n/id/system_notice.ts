...
const system_notice: TranslationStrings = {
  'system_notice.welcome_v1.title': 'Selamat datang di Tripp',
  ...
  'system_notice.welcome_v1.hero_alt': 'Destinasi wisata indah dengan antarmuka Tripp',
  ...
  'system_notice.thank_you_support.title': 'Terima kasih telah memakai Tripp',
  'system_notice.thank_you_support.body':
    'Sekadar ucapan terima kasih singkat karena telah memasang Tripp — ini benar-benar berarti banyak bagi saya.\n\nSaya seorang developer solo dan membangun Tripp di waktu luang. Awalnya hanya alat kecil untuk perjalanan saya sendiri, dan sejujurnya saya terharu dengan dukungan serta minat dari komunitas sejak saat itu. Tripp dibuat dengan sepenuh hati dari saya — tetapi juga berkat banyak kontributor eksternal hebat yang telah membantu membentuknya.\n\n**Tripp bersifat open source dan sepenuhnya gratis — dan akan selalu begitu, selamanya. Tanpa paket berbayar, tanpa langganan, tanpa syarat tersembunyi. Saya janji.**\n\nJika Tripp bermanfaat bagimu dan kamu ingin mendukung pengembangannya, secangkir kopi kecil sungguh membantu saya untuk terus membangun — sama sekali tanpa paksaan, tapi setiap cangkir membuat malam-malam panjang ini tetap berjalan.\n\nTerima kasih telah berada di sini.\n\n— Maurice',

...
const admin: TranslationStrings = {
  ...
  'admin.addons.subtitle': '啟用或停用功能以自定義你的 Tripp 體驗。',
  ...
  'admin.weather.description':
    'Tripp 使用 Open-Meteo 作為天氣資料來源。Open-Meteo 是免費的開源天氣服務——無需 API 金鑰。',
  ...
  'admin.github.support': '幫助我繼續開發 Tripp',
  'admin.github.error': '載入版本失敗',
  'admin.github.by': '作者',
  'admin.update.available': '有可用更新',
  'admin.update.text': 'Tripp {version} 已釋出。你當前使用的是 {current}。',
  'admin.update.button': '在 GitHub 檢視',
  'admin.update.install': '安裝更新',
  'admin.update.confirmTitle': '確定安裝更新？',
  'admin.update.confirmText': 'Tripp 將從 {current} 更新到 {version}。伺服器將自動重啟。',
  ...
  'admin.update.dockerText': '你的 Tripp 例項執行在 Docker 中。要更新到 {version}，請在伺服器上執行以下命令：',
  'admin.update.nonDockerText':
    '此 Tripp 例項並非執行在 Docker 中。要更新到 {version}，請重新執行你當初使用的安裝或更新方式——例如在 Proxmox Community Scripts 上，請從 LXC 主控臺執行更新：',

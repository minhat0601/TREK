...
const admin: TranslationStrings = {
  ...
  'admin.addons.subtitle': 'Schakel functies in of uit om je Tripp-ervaring aan te passen.',
  ...
  'admin.weather.description':
    'Tripp gebruikt Open-Meteo als weerbron. Open-Meteo is een gratis, open-source weerdienst — geen API-sleutel vereist.',
  ...
  'admin.github.support': 'Helpt mij Tripp verder te ontwikkelen',
  'admin.github.error': 'Releases laden mislukt',
  'admin.github.by': 'door',
  'admin.update.available': 'Update beschikbaar',
  'admin.update.text': 'Tripp {version} is beschikbaar. Je draait {current}.',
  'admin.update.button': 'Bekijk op GitHub',
  'admin.update.install': 'Update installeren',
  'admin.update.confirmTitle': 'Update installeren?',
  'admin.update.confirmText': 'Tripp wordt bijgewerkt van {current} naar {version}. De server herstart automatisch.',
  ...
  'admin.update.dockerText':
    "Je Tripp-instantie draait in Docker. Om bij te werken naar {version}, voer de volgende commando's uit op je server:",
  'admin.update.nonDockerText':
    'Deze Tripp-instantie draait niet in Docker. Om bij te werken naar {version}, voer de installatie- of updatemethode die je hebt gebruikt opnieuw uit — bij Proxmox Community Scripts voer je de update bijvoorbeeld uit vanuit de LXC-console:',

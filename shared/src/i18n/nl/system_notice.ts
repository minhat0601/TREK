...
const system_notice: TranslationStrings = {
  'system_notice.welcome_v1.title': 'Welkom bij Tripp',
  ...
  'system_notice.welcome_v1.hero_alt': 'Schilderachtige reisbestemming met Tripp interface',
  ...
  'system_notice.thank_you_support.title': 'Bedankt voor het gebruik van Tripp',
  'system_notice.thank_you_support.body':
    "Even een kort bedankje dat je Tripp hebt geïnstalleerd — het betekent echt veel voor me.\n\nIk ben een solo-ontwikkelaar en bouw Tripp in mijn vrije tijd. Het begon als een klein hulpmiddel voor mijn eigen reizen, en ik ben oprecht overweldigd door de steun en de interesse vanuit de community sindsdien. Tripp is met heel veel hart gemaakt aan mijn kant — maar ook dankzij de vele geweldige externe bijdragers die hebben geholpen het vorm te geven.\n\n**Tripp is open source en volledig gratis — en dat zal het voor altijd blijven. Geen betaalde versies, geen abonnementen, geen addertjes onder het gras. Dat beloof ik.**\n\nAls Tripp nuttig voor je is en je de ontwikkeling ervan wilt steunen, helpt een klein kopje koffie me oprecht om te blijven bouwen — absoluut geen druk, maar elk kopje houdt de late avonden gaande.\n\nBedankt dat je er bent.\n\n— Maurice",

...
const settings: TranslationStrings = {
  ...
  'settings.about.supporters.title': 'Trippの旅仲間',
  'settings.about.supporters.subtitle': '皆さんの支援がTrippの未来を支えています。',
  ...
  'settings.about.description': 'Trippはセルフホスト型の旅行プランナーです。',
  ...
  'settings.airtrail.writeBackHint':
    '既定ではオフ: AirTrail が信頼できる情報源で、Tripp は読み取りのみを行います。Tripp で行った編集を AirTrail に書き戻すにはオンにします。',

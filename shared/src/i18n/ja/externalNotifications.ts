...
const ja: NotificationLocale = {
  email: {
    footer: 'Trippで通知を有効にしているため、このメールが届きました。',
    manage: '設定で通知設定を管理',
    madeWith: 'Made with',
    openTrek: 'Trippを開く',
  },
  events: {
    ...
    vacay_invite: (p) => ({
      ...
      body: `${p.actor}が休暇プランの統合に招待しています。Trippを開いて承認または拒否してください。`,
    }),
    photos_shared: (p) => ({
    ...
    version_available: (p) => ({
      title: '新しいTrippバージョンが利用可能',
      body: `Tripp ${p.version}が利用可能になりました。管理パネルからアップデートしてください。`,
    }),
  ...
  passwordReset: {
    subject: 'パスワードをリセット',
    greeting: 'こんにちは',
    body: 'Trippアカウントのパスワードリセットリクエストを受け付けました。以下のボタンをクリックして新しいパスワードを設定してください。',
    ctaIntro: 'パスワードをリセット',

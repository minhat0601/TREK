...
const admin: TranslationStrings = {
  ...
  'admin.addons.subtitle': '機能を有効／無効にしてTrippをカスタマイズします。',
  ...
  'admin.weather.description':
    'Trippは天気データにOpen‑Meteoを使用しています。無料でオープンソース、APIキーは不要です。',
  ...
  'admin.github.by': '作成者',
  'admin.github.support': 'Trippの開発を支援',
  'admin.update.available': '更新があります',
  'admin.update.text': 'Tripp {version} が利用可能です。現在は {current} を使用しています。',
  'admin.update.button': 'GitHubで見る',
  'admin.update.install': '更新をインストール',
  'admin.update.confirmTitle': '更新をインストールしますか？',
  'admin.update.confirmText': 'Trippを {current} から {version} に更新します。更新後、サーバーは自動的に再起動します。',
  ...
  'admin.update.dockerText':
    'TrippはDockerで実行されています。{version} に更新するには、サーバーで次のコマンドを実行してください：',
  'admin.update.nonDockerText':
    'このTrippインスタンスはDockerで実行されていません。{version} に更新するには、使用したインストールまたは更新方法をもう一度実行してください。たとえばProxmox Community Scriptsの場合は、LXCコンソールから更新を実行します：',

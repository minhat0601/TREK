...
const admin: TranslationStrings = {
  ...
  'admin.addons.subtitle': 'Zapněte nebo vypněte funkce a přizpůsobte si Tripp.',
  ...
  'admin.github.by': 'od',
  'admin.github.support': 'Pomáhá udržovat vývoj Tripp',
  'admin.weather.title': 'Data o počasí',
  'admin.weather.badge': 'Od 24. března 2026',
  'admin.weather.description':
    'Tripp používá Open-Meteo jako zdroj dat. Je to bezplatná open-source služba – není vyžadován API klíč.',
  ...
  'admin.update.text': 'Tripp {version} je k dispozici. Aktuálně používáte verzi {current}.',
  ...
  'admin.update.confirmText':
    'Tripp bude aktualizován z verze {current} na {version}. Server se poté automaticky restartuje.',
  ...
  'admin.update.dockerText':
    'Váš Tripp běží v Dockeru. Pro aktualizaci na verzi {version} spusťte na svém serveru tyto příkazy:',
  'admin.update.nonDockerText':
    'Tato instance Tripp neběží v Dockeru. Pro aktualizaci na verzi {version} znovu spusťte instalační nebo aktualizační metodu, kterou jste použili — například u Proxmox Community Scripts spusťte aktualizaci z konzole LXC:',

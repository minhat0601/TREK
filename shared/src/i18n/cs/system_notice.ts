...
const system_notice: TranslationStrings = {
  'system_notice.welcome_v1.title': 'Vítejte v Tripp',
  ...
  'system_notice.welcome_v1.hero_alt': 'Malebné cestovní místo s rozhraním Tripp',
  ...
  'system_notice.thank_you_support.title': 'Děkuji, že používáte Tripp',
  'system_notice.thank_you_support.body':
    'Rychlé poděkování za to, že jste si nainstalovali Tripp — upřímně, znamená to pro mě hodně.\n\nJsem jediný vývojář a Tripp tvořím ve svém volném čase. Začalo to jako malý nástroj jen pro mé vlastní cesty a od té doby mě podpora a zájem komunity naprosto dostávají. Tripp dělám s velkým srdcem — ale také díky mnoha úžasným externím přispěvatelům, kteří ho pomohli utvářet.\n\n**Tripp je open source a zcela zdarma — a tak to navždy zůstane. Žádné placené verze, žádná předplatná, žádné háčky. Slibuji.**\n\nPokud je pro vás Tripp užitečný a chtěli byste podpořit jeho vývoj, malá káva mi opravdu pomáhá pokračovat ve tvoření — žádný tlak, ale každý šálek mi pomáhá přečkat pozdní noci.\n\nDěkuji, že jste tady.\n\n— Maurice',

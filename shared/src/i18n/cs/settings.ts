...
const settings: TranslationStrings = {
  ...
  'settings.about.supporters.title': 'Společníci na cestě s Tripp',
  'settings.about.supporters.subtitle':
    'Zatímco plánuješ další trasu, tihle lidé plánují společně se mnou budoucnost Tripp. Jejich měsíční příspěvek jde přímo na vývoj a reálně strávené hodiny — aby Tripp zůstal Open Source.',
  ...
  'settings.about.description':
    'Tripp je samohostovaný plánovač cest, který vám pomůže organizovat výlety od prvního nápadu po poslední vzpomínku. Denní plánování, rozpočet, balicí seznamy, fotky a mnoho dalšího — vše na jednom místě, na vašem vlastním serveru.',
  ...
  'settings.airtrail.writeBackHint':
    'Ve výchozím stavu vypnuto: AirTrail je zdrojem pravdy a Tripp z něj pouze čte. Zapněte, chcete-li odesílat úpravy provedené v Tripp zpět do AirTrail.',

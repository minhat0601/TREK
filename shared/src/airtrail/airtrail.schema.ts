...
export const airtrailSettingsSchema = z.object({
  /** Instance origin, e.g. https://flights.example.com — Tripp appends /api itself. */
  ...
  /**
   * Opt in to writing Tripp edits back to AirTrail (#1240). Off by default:
   * AirTrail is the source of truth and Tripp only reads from it.
   */
